<div class="container-xxl">
    <p><table class="table table-hover table-bordered "><p>
            ...
            <?php use Libs\Model;
            $pdo = new Model();
            $all_product = $pdo->connection->query("SELECT * FROM `product` ; ")->fetchAll(PDO::FETCH_ASSOC);
            foreach ($all_product as $value){
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/product/delproduct?id=<?php echo $value['id'] ?>" ><button name="delete" type="button" class="btn btn-danger"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-trash" viewBox="0 0 16 16">
